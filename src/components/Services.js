                ...
                <div className="mx-5 my-3 p-5 card">
                    <div className="row">
                        ...
                        <div className="col-sm-9 my-auto">
                            <h4>Home Tutoring</h4>
                            <p>Studies have shown that children learn best when being taught one-to-one and in comfortable and familiar surroundings. For this reason I travel to you to tutor as I firmly believe children learn best in the comfort of their own home.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="mx-5 my-3 p-5 card">
                    <div className="row">
                        ...
                        <div className="col-sm-9 my-auto">
                            ...
                            <p>I also offer bespoke tuition for other less common exams e.g. Nursing exams, MAT (Oxford entrance exam), STEP (Cambridge entrance exam) and undergraduate engineering exams.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="mx-5 my-3 p-5 card">
                    <div className="row">
                        ...
                        <div className="col-sm-9 my-auto">
                            ...
                            <p>At Easter and just prior to the exams I offer three-hour revision sessions. During these we target areas that are in need of development and also practice exam technique. These are tough sessions but the results speak for themselves!</p>
                        </div>
                    </div>
                </div>
            </div>
